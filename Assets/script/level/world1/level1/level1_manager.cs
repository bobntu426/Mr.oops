...
public class level1_manager : MonoBehaviour
{
    ...
    public GameObject ball, pointer,man, equipment, detect,sound;
    ...
    void a_round()
    {
        ...
        random3 = Random.Range(1, 8);//´XÁû²y
    ...
    {
        man_control.man.round++;
        if (man_control.man.round > playerprefs_info.player.world1_score[0])
        {
            PlayerPrefs.SetInt("score1-1", man_control.man.round);
            playerprefs_info.player.world1_score[0] = PlayerPrefs.GetInt("score1-1");
        }
